...
import com.sampath.akshay.interactivestory.model.Page;
import com.sampath.akshay.interactivestory.model.Story;
...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mName = intent.getStringExtra(getString(R.string.tag_name));
    ...
    private void loadPage(int choice){
        ...
        //Add the name if place holder included
